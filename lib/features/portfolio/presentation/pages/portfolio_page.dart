                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            CurrencyUtils.getSymbol(country.currencyCode, context: context),
                            style: const TextStyle(
                              fontSize: 16,
                      ...
                      if (portfolioProviderInstance.totalPureWeightGrams > 0) ...[
                        ...
                        Builder(builder: (context) {
                          ...
                          final totalUsd = portfolioProviderInstance.totalPureWeightGrams * usdGram24;
                          return Text(
                      ...
                      Row(
                        ...
                        children: [
                          _buildPortfolioStat(
                            ...
                            value: '${isProfit ? "+" : ""}${numberFormat.format(totalPnL)} ${CurrencyUtils.getSymbol(country.currencyCode, context: context)}',
                            color: isProfit ? AppColors.liveGreen : Colors.redAccent,
                          ),
                          _buildPortfolioStat(
  ...
  Widget _buildAssetCard(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: isDark ? AppColors.gold.withValues(alpha: 0.2) : const Color(0xFFE2E8F0)),
        boxShadow: [
          BoxShadow(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'asset_weight_and_cost'.tr(args: [
                    item.weightGrams.toString(),
                    '${numberFormat.format(item.totalInvestedCost)} ${CurrencyUtils.getSymbol(item.currencyCode.isNotEmpty ? item.currencyCode : country.currencyCode, context: context)}'
                  ]),
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Text('auto_str_154'.tr(), style: const TextStyle(fontWeight: FontWeight.w900, color: Colors.white, fontSize: 15, fontFamily: 'Cairo')),
                      ),
                    ),
                  ],
                ),
